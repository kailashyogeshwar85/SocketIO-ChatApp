...
require('./utilities/user-agent-helper.js');
/*
Constants
*/
...
var appCons = module.exports = R.curry(function(options, apiKey) { //app Constructor
  ...
  */
  ...
  var curriedAnalytics    = Analytics(app, {}, [], attachConfigGenerator());
  ...
  */
  ...
  /** 
    ...
    @example
      var analytics = Built.App('api_key').Analytics(); //Returns an instance of {@link Analytics}
  */
  app.Analytics = utility.wrapper(curriedAnalytics,[true, 1, {}])
...
//Attaches a generator method that extracts information from the browser and node for analytics
function attachConfigGenerator(){
  var generate = function(){
    return ({});
  };
  pluginsHelper.plugins.map(function(plugin){
    if(plugin.analyticsConfig && plugin.analyticsConfig.generate){
      generate =  plugin.analyticsConfig.generate;
      return
    }
  });
  //if the plugin is not included no default properties would be sent
  return generate;
}
...
/**
  Sets authentication token in the app header
  @memberof App
...
/**
  Sets the storage medium that should be used to maintain session
  @memberof App
  @function persistSessionWith
  @param {Constant} persistSession Built persistance constant
  @instance
  @example
  var app = Built.App('api_key').persistSessionWith(Built.Session.COOKIE); // Returns an app that would use cookie to persist sessions
  @return {App}
*/
...
/**
  ...
  @instance
  @example
  var app = Built.App('api_key').setCachePolicy(Built.CachePolicy.CACHE_ELSE_NETWORK); //Returns an app which would use CACHE_ELSE_NETWORK as its cache policy
  @return {App}
*/
...
/**
  Returns the cache policy that is being followed by the app instance
  @memberof App
...
/**
  ...
  @instance
  @example
    var app = Built.App('api_key').setHeader('My-Custom-Header','MyValue'); //Sets a header and returns an app instance
  @return {App}
*/
...
/**
  ...
  @instance
  @example
  var app = Built.App('api_key').setProtocol('http') // Sets protocol to http and returns new app instance
  @return {App}
*/
...
/**
  Using this method, we can specify which adaptor should be used
  @function setAdaptor
  @memberof App
  @instance
  @param {String} version The version of built.io to be used
  @example
