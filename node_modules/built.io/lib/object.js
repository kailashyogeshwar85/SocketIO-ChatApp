...
/**
  ...
  @example
  var Person = Built.App('api_key').Class('person').Object; // returns an Object Constructor
...
/**
  ...
  @example
  var person  = Built.App('api_key').Class('person').Object();
  person      = person.decrement('age',10); //Decreases age field value by 10
  @return {Object}
*/
...
/**
  ...
  @example
  var person  = Built.App('api_key').Class('person').Object();
  person      = person.increment('age',10); //Increases age field value by 10
  @return {Object}
*/
...
/**
  ...
  @example
  var person  = Built.App('api_key').Class('person').Object();
  person      = person.multiply('age',10); //multiplies age field value by 10
  @throws new Error('Not a number');
  @instance
  @memberof Object
  @return {Object}
...
/**
  ...
  person      = person.set('name','testname'); 
  @return {String}
*/
...
  @instance
  ...
  person      = person.upsert({ name:'ABC' });                      //If object having its name field as ABC is found, it is updated, else it creates a new object on built.io
...
/**
 Fires a query on built.io and all the objects that pass the query condition are assigned to the reference field.#
...
/**
 ...
 @example
  ...
  var newObject = person.upsertForReference('ref_address', {city:'Bombay'}, {name: 'Mumbai'});  
    // The method would first check Address class (the class referred by person class in ref_address field) and checks if any city(s) with name 'Bombay' exists; if yes, it would be replaced by Mumbai.
...
  @instance
  ...
  @example
    ...
    personWithUid.save()                // As the object has a uid property set, an update request is sent to built.io.
      .then(function(object){
        // updated object  
      });
...
/**
  Fetches the latest version of the object from built.io
  @function fetch
...
/**
  ...
  @param {Model} model Takes the Backbone model to be used for conversion. (If no model is specified, built.io's default model would be used.)
  @instance
  @memberof Object
  @example
    ...
    //Now "backbone" can be used to fetch, save, delete, update object on built.io.
    backbone.save(null,{
